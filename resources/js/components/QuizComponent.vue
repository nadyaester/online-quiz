        ...
        <div class="col">
            <div class="card">
                <div class="card-header">Online Examination
                        <span class="float-right">{{questionIndex+1}}/{{questions.length+1}}</span>
                </div>
                <div class="card-body">
                    ...
                    <div v-for="(question,index) in questions">
                        <div v-show="index===questionIndex">
                            ...
                            <img :src="'/images/'+ question.image" width="250" height="250">
                            </div>
                    ...
                    <div v-show="questionIndex!=questions.length">
                        <button class="btn btn-default float-left" @click="prev()">Prev</button>
                        <button class="btn btn-default float-right" @click="next();postuserChoice()">Next</button>
                    </div>

                    <div v-show="questionIndex===questions.length">
                        <p><center>You got : {{score()}}/{{questions.length}}</center></p>
                    </div>
                </div>
            </div>
        </div>
